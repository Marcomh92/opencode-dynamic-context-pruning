...
> "selectively used on the most critical contract tests — coalesce-save, append-idempotency, synthetic-user-message-stability are the reference set; add when a test pins a documented invariant (e.g., INV-_, DPP-_)."
...
Narrowed PAT-012 in `docs/PATTERNS.md` to `selectively used on the most critical contract tests`; matches reality.
