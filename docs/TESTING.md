...
| State                     | `state-schema-version.test.ts`, `state-max-age.test.ts`, `state-persistence-hygiene.test.ts`, `load-session-state-skips-subagents.test.ts`, `recovery-not-persisted.test.ts`                                                                                                                                                                                                                                                                                                                                                                                                     |
