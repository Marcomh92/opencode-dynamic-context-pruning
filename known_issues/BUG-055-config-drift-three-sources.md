...
- **Bonus**: `docs/CONFIGURATION.md:46-52` lists *four* override paths for prompts (`global`, `configDir`, `project`, `defaults`) — consistent with the four-layer model. So "four sources" matches the doc's own internal vocabulary.