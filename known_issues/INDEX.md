...
| BUG-099 | Compression notification headline leaked cumulative summary tokens across compresses and lacked the `#N` compression marker; detail line showed per-compression instead of cumulative totals | Low                           | Fixed  | 2026-09-25 |
