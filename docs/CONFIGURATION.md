...
| `compress.summaryBuffer`            | `true`            | `lib/config.ts:1014`                                                                                                                           |
| `compress.summaryBufferMinRatio`    | `0.2`             | `lib/config.ts:1015`; fraction of active summary tokens added to `minContextLimit` when `summaryBuffer` is true; set to `0` to disable cleanly |
