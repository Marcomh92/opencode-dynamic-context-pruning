...
- **Bonus**: the framing in the report treats "comments mention issue numbers, not invariants" as a deficiency — but issue numbers in test names are the documented convention, PAT-013 (`docs/PATTERNS.md:101-103`) and `docs/TESTING.md:44`. INV tags should be *added alongside*, not presented as a correction.
